...
class LogModel extends CommonModel
{
     ...
     */
    public function getKeyuseLog($logid=null, $departmentno=null, $cabinetno=null, $keyno=null, $userno=null, $username=null, $action=null, $actionflag=null, $begintime=null, $endtime=null, $start=0, $length=9999, $keyname=null)
    {
        $where = array();
        if ($logid) $where['logid'] = is_array($logid) ? array('in', $logid) : $logid;
        if ($departmentno) $where['a.departmentno'] = is_array($departmentno) ? array('in', $departmentno) : $departmentno;
